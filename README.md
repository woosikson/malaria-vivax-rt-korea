...
| **Fig 4**  | `Fig4.eps/.tiff`   | `fig4_monthly_Rt_expected_cases.R`     | Monthly mean *Rₜ* and expected secondary cases (dual axis) |
| **Fig 5**  | `Fig5.eps/.tiff`   | `fig5_yearly_Rt.R`                     | Annual mean *Rₜ* |
