#!/usr/bin/env Rscript
#
# Fig 4 — Annual mean case reproduction number R_t (alpha=beta=0.3, 2015-2023).
#   Same scheme as Fig 5 / S2 Fig: black line + points, horizontal grid only,
...
#
# Run: Rscript figures/fig4_yearly_Rt.R
...
OUT <- file.path(FIGDIR, "Fig4"); REF_COL <- "grey50"
